...
Layout: Grid-based product listings, strong CTAs, promotional visual banners.
...
Tech Stack: HTML
(Note: expand to HTML/CSS/JS and lightweight backend/headless e-commerce for production)      

7. | Week   | Milestone                                   |
   | ------ | ------------------------------------------- |
   | Week 1 | Proposal approval and content gathering     |
   | Week 2 | Wireframes and sitemap creation             |
   | Week 3 | Homepage design and HTML structure          |
   | Week 4 | Build remaining pages and integrate backend |
   | Week 5 | Testing, security checks, and revisions     |
   | Week 6 | Final deployment and staff training         |
...
Design tools: R1,000/year

Development & testing: R15,000 (once-off)

Total: R18,650

9. NEW SECTION ADDED — CSS Implementation Notes

This section outlines how to structure and include CSS for the Pick n Pay site. Use a modular, maintainable approach with a base stylesheet and component-specific files:

Recommended CSS File Structure

base.css — reset, variables, typography

layout.css — grid, header, footer, containers

components.css — cards, banners, buttons

forms.css — inputs, labels, messages

Accessibility & Performance Guidelines

Use system or web-safe fallback fonts for faster loading
...
File naming convention (recommended): ---.png — e.g. homepage-desktop-v1.png, checkout-mobile-step2-v1.png.
